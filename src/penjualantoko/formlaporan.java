...
public class formlaporan extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            Desktop.getDesktop().browse(new URL("http://localhost/phpmyadmin/sql.php?server=1&db=elektronik&table=tbl_tmp_beli&pos=0").toURI());
            } catch (Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            Desktop.getDesktop().browse(new URL("http://localhost/phpmyadmin/sql.php?db=elektronik&table=tbl_beli&pos=0").toURI());
            } catch (Exception e){
                System.out.println(e);
            }
